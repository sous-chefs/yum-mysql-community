...
yum_repository 'mysql56-community' do
  ...
  baseurl node['yum']['mysql56-community']['baseurl'] if  node['yum']['mysql56-community']['baseurl'].nil?
  mirrorlist node['yum']['mysql56-community']['mirrorlist'] unless node['yum']['mysql56-community']['mirrorlist'].nil?
  gpgcheck node['yum']['mysql56-community']['gpgcheck'] if  node['yum']['mysql56-community']['gpgcheck'].nil?
  gpgkey node['yum']['mysql56-community']['gpgkey'] if  node['yum']['mysql56-community']['gpgkey'].nil?
  ...
  enablegroups node['yum']['mysql56-community']['enablegroups'] if  node['yum']['mysql56-community']['enablegroups'].nil?
  failovermethod node['yum']['mysql56-community']['failovermethod'] unless node['yum']['mysql56-community']['failovermethod'].nil?
  http_caching node['yum']['mysql56-community']['http_caching'] if  node['yum']['mysql56-community']['http_caching'].nil?
  ...
  keepalive node['yum']['mysql56-community']['keepalive'] if  node['yum']['mysql56-community']['keepalive'].nil?
  ...
  mirror_expire node['yum']['mysql56-community']['mirror_expire'] if  node['yum']['mysql56-community']['mirror_expire'].nil?
  ...
  proxy_username node['yum']['mysql56-community']['proxy_username'] if  node['yum']['mysql56-community']['proxy_username'].nil?
  proxy_password node['yum']['mysql56-community']['proxy_password'] if  node['yum']['mysql56-community']['proxy_password'].nil?
  repositoryid node['yum']['mysql56-community']['repositoryid'] if  node['yum']['mysql56-community']['repositoryid'].nil?
  ...
  timeout node['yum']['mysql56-community']['timeout'] if  node['yum']['mysql56-community']['timeout'].nil?
  action :create
end
